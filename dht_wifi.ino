...
#define SSID "Ron96"     // "SSID-WiFiname" 
#define PASS "sayantanbarai"       // "password"
#define IP "184.106.153.149"// thingspeak.com ip
String msg = "GET /update?key=DNJNTU2U3SXYQLYZ"; //change it with your key...
/*-----------------------------------------------------------*/
...
void loop(){
  ...
  delay(15000); //Update every 1 hour
}
